...
WindUI:Popup({
    Title = "脚本",
    IconThemed = true,
    Content = "欢迎尊贵的用户" .. game.Players.LocalPlayer.Name .. "使用脚本 当前版本型号:V2",
    Buttons = {
        {
            Title = "取消",
...
function createUI()
    local Window = WindUI:CreateWindow({
        Title = "脚本付费版",
        Icon = "palette",
    Author = "尊贵的"..game.Players.localPlayer.Name.."欢迎使用脚本", 
        Folder = "Premium",
...
local campfireDropPos = Vector3.new(1.4, 25.9, -0.9)
...
Main:Button({
    ...
    Callback = function()
        ...
        if char and char:FindFirstChild("HumanoidRootPart") then
            char.HumanoidRootPart.CFrame = CFrame.new(-0.09672313928604126, 7.937822341918945, -0.1782056838274002)
        end
    end
})
...
Main:Toggle({
    ...
    Callback = function(value)
        ...
        if autohlod then
            ...
            instantConn = workspace.DescendantAdded:Connect(function(instance)
